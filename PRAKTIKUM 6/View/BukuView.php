  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="">Apakah anda yakin menghapus data dengan 1 id <span id="textId"></span> ini?</p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <script>
      var exampleModal = document.getElementById('hapusModal')
exampleModal.addEventListener('show.bs.modal', function (event) {
  ...
  var modalTitle = hapusModal.querySelector('#idHapus')
  var modalBodyInput = hapusModal.querySelector('#textId')
